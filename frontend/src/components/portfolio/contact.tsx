...
export default function Contact() {
  const { email, resumeHref, socials } = CONTACT_CONFIG;

  return (
    <section id="contact" className="py-20 relative">
      <div className="glass-card rounded-xl p-8 text-center border-t border-cyan-500/30">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
            <a
              href={`mailto:${email}`}
              className="inline-flex items-center justify-center gap-2 font-semibold px-8 py-3 rounded-lg
                         bg-gradient-to-b from-cyan-600 to-blue-600
                         hover:shadow-lg hover:shadow-cyan-500/50
                         hover:-translate-y-1 transition-all max-sm:w-full"
            >
              <EnvelopeIcon />
              Email Me
            </a>
            ...
            <div className="flex justify-center gap-4 pt-4">
              {socials.map(({ label, href, icon }) => (
                <a
                  ...
                  href={href}
                  aria-label={label}
                  className="w-12 h-12 glass-card rounded-lg flex items-center justify-center
